...
import sethMod.patches.relics.BottledPlaceholderField;
import sethMod.util.TextureLoader;

import java.util.Iterator;
import java.util.function.Predicate;

import static sethMod.DefaultMod.makeRelicOutlinePath;
import static sethMod.DefaultMod.makeRelicPath;
